...
.DESCRIPTION
    This script:
    1. Activates Conda py311 environment (Python runtime only)
...
.USAGE
    ...
    Manual: & './scripts/powershell/conda-py311-init-env.ps1'
...
.SETUP
    ...
    "terminal.integrated.profiles.windows": {
        "PowerShell (Conda + uv)": {
            "source": "PowerShell",
            "args": ["-NoExit", "-Command", "& 'C:\\Users\\203715\\Documents\\Repo\\cr-misc-function\\cr-misc-function\\scripts\\powershell\\conda-py311-init-env.ps1' ; cd '.\\<project>\\'"]
        }
    },
...
# Confirm status
Write-Host ""
Write-Host "[OK] Conda py311 activated" -ForegroundColor Green
Write-Host ""
python --version
