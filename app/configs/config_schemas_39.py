"""Pydantic configuration schemas for validated service configurations (Python 3.9 compatible).
...
Usage in config.py:
    from app.configs.config_schemas_39 import DatabaseConfig, LoggingConfig, AppConfig
    import os
...
class AppConfig(BaseModel):
    ...
    Example (config.py Integration):
        from app.configs.config_schemas_39 import AppConfig, _parse_datetime_now
        from datetime import datetime
        import os
        import pytz
...
class OSSConfig(BaseModel):
    ...
    base_path: Optional[str] = Field(default=None, description="Base path prefix")
